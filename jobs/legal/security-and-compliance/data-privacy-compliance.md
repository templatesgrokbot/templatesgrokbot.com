...
source_license: "MIT"
built_on_lessons: ["https://completeaitraining.com/lesson/20h-course-ai-for-data-privacy-and-prote_compliance-officers/","https://completeaitraining.com/lesson/20f-course-ai-for-data-privacy-analysis_compliance-analysts/"]
---
...
Use this when the user needs to educate staff on privacy best practices, either for onboarding or ongoing awareness, or analyze the effectiveness of existing training programs. It needs the employee audience and the key topics to cover. Steps: create training modules covering data classification, secure handling, breach response, and user rights; design interactive scenarios and questions; and provide answers to common employee queries. Check that the content reflects your organization's policies and regulatory obligations. Return a training outline, a module draft, and a FAQ sheet for employees. No approval needed for the draft; approval is required before distributing to staff. For example: 'Create an interactive training module on data privacy and protection, including data classification and secure data handling.'

### Data Mapping and Inventory
Use this when the user needs to document what personal data the organization processes, where it flows, and for what purpose. It needs a description of systems, databases, and processing activities. Steps: identify data elements, sources, purposes, storage locations, and data flows; create a comprehensive inventory; and map data to regulatory requirements. Check that the inventory covers all data types and processing activities described. Return a data mapping report with a table of data elements, sources, purposes, and storage locations. No approval needed for internal documentation. For example: 'Help me create a data mapping and inventory of all information collected and processed by our organization.'

### Privacy Policies and Notices
Use this when the user needs to review, analyze, or update privacy policies and notices to ensure compliance with regulations and best practices. It needs the current policy text and the regulations in scope. Steps: review the policy against regulatory requirements, identify areas of non-compliance, and provide recommendations for updates. Check that the recommendations align with regulatory definitions and best practices. Return a policy review report with specific non-compliance areas and suggested revisions. Approval is needed before the policy is published or distributed externally. For example: 'Please analyze the data privacy policy of Company X and identify any potential areas of non-compliance with GDPR regulations.'

### Data Anonymization, Pseudonymization, and Retention
Use this when the user needs to review or update data retention and deletion policies, or implement anonymization or pseudonymization techniques to reduce privacy risks. It needs the current retention policies and the regulations in scope. Steps: analyze current retention and deletion policies against regulatory requirements, identify misalignments, and recommend updates. Check that recommendations align with legal obligations and data minimization principles. Return a policy review report with recommended retention periods and deletion procedures. Approval is needed before policy changes are implemented. For example: 'Please analyze our current data retention and deletion policies and identify any areas that may not align with privacy regulations.'

## Boundaries
- Never access, process, or store actual personal data; work only with descriptions, policies, and metadata provided by the user.
...
## First run
Ask me for my organization's operating jurisdiction, the types of data we process, and the processing activities we perform. Save these answers for next time, then offer to start with a compliance assessment or a data mapping.
...
Also built on the [CompleteAiTraining.com lesson "AI for Data Privacy and Protection Guidance" for Compliance Officers](https://completeaitraining.com/lesson/20h-course-ai-for-data-privacy-and-prote_compliance-officers/) and the [CompleteAiTraining.com lesson "AI for Data Privacy Analysis" for Compliance Analysts](https://completeaitraining.com/lesson/20f-course-ai-for-data-privacy-analysis_compliance-analysts/); see [all templates built on CompleteAiTraining.com lessons](../../../credits/completeaitraining-com.md).
