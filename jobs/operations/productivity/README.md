...
| [Meeting Notes](meeting-notes.md) | Turns a transcript into decisions and owned actions, dropping everything that was just talk. |
...
| [Microsoft Teams Automation](microsoft-teams-automation.md) | Automate Microsoft Teams messaging, meetings, channels, and searches. |
| [Miro Automation](miro-automation.md) | Automate Miro boards, items, sticky notes, frames, sharing, and connectors via Rube MCP. |
| [Monday Automation](monday-automation.md) | Automate Monday.com work management with board, item, column, group, and subitem operations via Rube MCP. |
...
| [New Bot](new-bot.md) | This bot performs the exact function described in the source template. |
...
| [Notion Automation](notion-automation.md) | Automate Notion pages, databases, blocks, comments, and users via Rube MCP. |
...
| [Pipedrive Automation](pipedrive-automation.md) | Automate Pipedrive CRM deals, contacts, activities, and notes via Rube MCP. |
...
| [Shopify Automation](shopify-automation.md) | Automate Shopify product, order, customer, inventory, and collection tasks via Rube MCP. |
| [Slack Automation](slack-automation.md) | Sends Slack messages, searches conversations, and manages channels with user approval. |
