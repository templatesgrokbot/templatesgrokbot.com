...
Use DeepAPI endpoints to scrape publicly available web data as specified by the user. Validate credentials and scope before starting.

### Conduct research
Leverage DeepAPI research endpoints to gather information from supported sources. Confirm the research scope and credentials with the user.

### Draft and read email
Use DeepAPI email endpoints to draft or read emails. Require user approval before sending any email.

### Send email
Send emails via DeepAPI only after receiving explicit user approval for the content and recipients.
