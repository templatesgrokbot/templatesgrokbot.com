...
Infrastructure, deployments, monitoring and incident response. 179 Grok Bot templates, 2 of them filed in this folder; the others live under their main field and are linked from here.
...
| [Aws Secrets Rotation](../../it-and-development/cloud-and-devops/aws-secrets-rotation.md) | Automate AWS secrets rotation for RDS, API keys, and credentials using Lambda. |
...
| [Azure Mgmt Fabric Py](../../it-and-development/cloud-and-devops/azure-mgmt-fabric-py.md) | Manage Microsoft Fabric capacities and resources via Azure SDK. |
| [Azure Mgmt Mongodbatlas Dotnet](../../it-and-development/cloud-and-devops/azure-mgmt-mongodbatlas-dotnet.md) | Manage MongoDB Atlas organizations as Azure ARM resources with unified billing. |
| [Azure Monitor Ingestion Py](../../it-and-development/cloud-and-devops/azure-monitor-ingestion-py.md) | Send custom logs to Azure Monitor Log Analytics using the Logs Ingestion API. |
| [Azure Monitor Opentelemetry Py](../../it-and-development/cloud-and-devops/azure-monitor-opentelemetry-py.md) | One-line Application Insights setup with OpenTelemetry auto-instrumentation for Python apps. |
| [Azure Monitor Query Py](../../it-and-development/cloud-and-devops/azure-monitor-query-py.md) | Query Azure Monitor logs and metrics using Python SDK. |
| [Azure Resource Manager Cosmosdb Dotnet](../../it-and-development/cloud-and-devops/azure-resource-manager-cosmosdb-dotnet.md) | Provision and manage Azure Cosmos DB resources via ARM SDK. |
| [Azure Resource Manager Mysql Dotnet](../../it-and-development/cloud-and-devops/azure-resource-manager-mysql-dotnet.md) | Manage Azure MySQL Flexible Server deployments with the .NET SDK. |
| [Azure Resource Manager Playwright Dotnet](../../it-and-development/cloud-and-devops/azure-resource-manager-playwright-dotnet.md) | Provision and manage Playwright Testing workspaces via Azure Resource Manager. |
...
| [Circleci Automation](../../it-and-development/cloud-and-devops/circleci-automation.md) | Trigger and monitor CircleCI pipelines, workflows, jobs, artifacts, and test results via Rube MCP. |
| [Claude Monitor](../../it-and-development/cloud-and-devops/claude-monitor.md) | Diagnose slowness in Claude Code and the local system with CPU, RAM, disk, and network. |
| [Cloud Devops](../../it-and-development/cloud-and-devops/cloud-devops.md) | Drafts cloud infrastructure, CI/CD, containers, and monitoring plans for AWS, Azure, and GCP. |
...
| [Github Actions Debugger](../../it-and-development/cloud-and-devops/github-actions-debugger.md) | Diagnose and fix failing GitHub Actions workflows by parsing logs and pipeline definitions. |
| [GitHub Actions Saver](../../it-and-development/cloud-and-devops/github-actions-saver.md) | Diagnoses GitHub Actions minute limits, sets a budget, and slims down workflows to cut CI costs. |
| [Github Workflow Automation](../../it-and-development/cloud-and-devops/github-workflow-automation.md) | Generate GitHub Actions workflows for PR review, issue triage, and CI/CD. |
...
| [Mailtrap Sending Emails](../../it-and-development/cloud-and-devops/mailtrap-sending-emails.md) | Configure Mailtrap live email sending via API, SMTP, or batch. |
| [Mailtrap Setting Up Sending Domain](../../it-and-development/cloud-and-devops/mailtrap-setting-up-sending-domain.md) | Add or verify a Mailtrap sending domain, publish SPF/DKIM/DMARC, and complete compliance. |
| [Make Automation](../../it-and-development/cloud-and-devops/make-automation.md) | Automate Make (Integromat) operations: list languages, timezones, and retrieve operation logs via Rube MCP. Always search tools first for current sche |
...
| [N8N Workflow Patterns](../../it-and-development/cloud-and-devops/n8n-workflow-patterns.md) | Guides users to select and build n8n workflows from five proven architectural patterns. |
| [Neon Expert](../../it-and-development/cloud-and-devops/neon-expert.md) | Guides Neon Serverless Postgres setup and coordinates with specialized agents. |
...
| [Observability Monitoring Slo Implement](../../it-and-development/cloud-and-devops/observability-monitoring-slo-implement.md) | Implement SLO frameworks and error budgets for service reliability. |
| [Observability Phoenix](../../it-and-development/cloud-and-devops/observability-phoenix.md) | Self-hosted AI observability for tracing, evaluating, and monitoring LLM applications. |
| [Odoo Backup Strategy](../../it-and-development/cloud-and-devops/odoo-backup-strategy.md) | Backup and restore Odoo databases and filestores with automated scripts. |
| [Odoo Docker Deployment](../../it-and-development/cloud-and-devops/odoo-docker-deployment.md) | Production-ready Docker setup for Odoo with PostgreSQL and Nginx reverse proxy. |
...
| [Pb Deploy](../../it-and-development/cloud-and-devops/pb-deploy.md) | Deploys PocketBase to production with Docker, systemd, reverse proxy, TLS, SMTP, backups, and hardening configs. |
| [Performance Monitor](../../it-and-development/cloud-and-devops/performance-monitor.md) | Tracks system metrics, detects anomalies, and optimizes resource usage across multi-agent environments. |
| [Platform Sre Kubernetes](../../it-and-development/cloud-and-devops/platform-sre-kubernetes.md) | Manages production Kubernetes deployments with safe rollouts, rollbacks, and security defaults. |
| [Postgres Pro](../../it-and-development/cloud-and-devops/postgres-pro.md) | Optimizes PostgreSQL performance, designs replication, and troubleshoots database issues at scale. |
| [Postgresql Dba](../../it-and-development/cloud-and-devops/postgresql-dba.md) | Manage PostgreSQL databases: query, modify, backup, and monitor performance. |
...
| [Powershell 5.1 Expert](../../it-and-development/cloud-and-devops/powershell-5-1-expert.md) | Generates safe, auditable PowerShell 5.1 scripts for Windows infrastructure automation. |
