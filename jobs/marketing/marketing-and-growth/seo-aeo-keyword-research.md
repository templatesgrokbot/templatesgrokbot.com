...
Identify 3–5 core terms that anchor the topic's search territory, including adjacent terms the audience actually uses.

### Expand Into Tiers
Sort all keywords into Tier 1 (low-to-moderate difficulty, target first), Tier 2 (medium difficulty, build toward after Tier 1 content is live), and Tier 3 (high difficulty, long-term goals only).

### Generate AEO Keywords
Produce question-based keywords that AI engines surface in direct answers and People Also Ask boxes. For each AEO keyword, specify the answer format (definition sentence, numbered steps, comparison table, direct number).
