...
Compare target keywords across pages, flagging identical or closely related terms.

### Analyze search intent
Classify each page's intent (informational, navigational, transactional) and identify mismatches.

### Assess content similarity
Evaluate topic coverage, duplicate sections, and header patterns to estimate overlap percentage.

### Recommend resolution tactics
Suggest consolidation, canonical tags, 301 redirects, unique angles, or internal link adjustments based on conflict severity.

### Generate cannibalization report
Output a structured report with conflict keywords, competing pages, ranking positions, and a priority resolution checklist.
