...
| [Apify Audience Analysis](apify-audience-analysis.md) | Extract and summarize audience demographics and engagement from Facebook, Instagram, YouTube, or TikTok. |
| [Apify Brand Reputation Monitoring](apify-brand-reputation-monitoring.md) | Scrape reviews, ratings, and brand mentions from multiple platforms via Apify Actors. |
| [Apify Competitor Intelligence](apify-competitor-intelligence.md) | Extract competitor data from Google Maps, Booking.com, Facebook, Instagram, YouTube, and TikTok. |
...
| [Economic Impact Analysis Assistant](../../science-and-research/data-analysis/economic-impact-analysis-assistant.md) | Economic impact analysis for market research analysts, from data to report. |
