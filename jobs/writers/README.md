...
|---|---|
| [Advertising Copywriting Assistant](writing-and-content/advertising-copywriting-assistant.md) | Drafts, refines, and adapts advertising copy across platforms for content writers. |
...
| [Api Documentation Generator](../it-and-development/writing-and-content/api-documentation-generator.md) | Generates comprehensive API documentation from codebases including OpenAPI specs, developer guides, and code examples. |
| [Audience Insight and Content Planner](writing-and-content/audience-insight-and-content-planner.md) | Turns audience data into content plans that fit your readers. |
| [Avoid Ai Writing](writing-and-content/avoid-ai-writing.md) | Audit and rewrite text to remove 21 categories of AI writing patterns. |
| [Beautiful Prose](writing-and-content/beautiful-prose.md) | A style contract for clean, exact, forceful English prose without AI tics. |
| [Blog Content Strategy Planner](writing-and-content/blog-content-strategy-planner.md) | Plan, create, and optimize blog content with AI-driven research and strategy. |
| [Blog Media Advisor](writing-and-content/blog-media-advisor.md) | Finds, optimizes, and formats images and media for blog posts, with sourcing and copyright guidance. |
| [Blog Post Creation Assistant](writing-and-content/blog-post-creation-assistant.md) | Guides bloggers from topic to published post with research, drafting, SEO, and editing. |
...
| [Doc Co-Authoring Workflow](writing-and-content/doc-coauthoring.md) | Guides users through co-authoring docs with context, refinement, and reader testing. |
...
| [Plot Structure Architect](writing-and-content/plot-structure-architect.md) | Structures plots, develops characters, and crafts endings for scriptwriters. |
...
| [Scene Development Assistant](writing-and-content/scene-development-assistant.md) | Develop vivid scenes with dialogue, setting, conflict, and plot, all in one place. |
| [Scientific Writing](../science-and-research/writing-and-content/scientific-writing.md) | Drafts full-paragraph scientific manuscripts using IMRAD structure with verified citations and figures. |
| [Script Conflict Developer](writing-and-content/script-conflict-developer.md) | Develops conflicts, resolutions, and dialogue for scripts across genres and settings. |
| [Script Dialogue Enhancer](writing-and-content/script-dialogue-enhancer.md) | Crafts character-driven, nuanced dialogue for scripts, from tone to subtext. |
| [Script Feedback Assistant](writing-and-content/script-feedback-assistant.md) | Script feedback on drafts: grammar, plot, characters, dialogue, pacing, tone, and market fit. |
| [Script Formatting Assistant](writing-and-content/script-formatting-assistant.md) | Formats your scripts to industry standards and keeps them consistent from first draft to final submission. |
| [Script Idea Generator](writing-and-content/script-idea-generator.md) | Generates and refines script ideas from brainstorm to polished concept. |
| [Script Pacing and Rhythm Assistant](writing-and-content/script-pacing-and-rhythm-assistant.md) | Adjusts script pacing and rhythm across dialogue, scenes, and full narratives. |
| [Script Theme and Motif Analyst](writing-and-content/script-theme-and-motif-analyst.md) | Analyzes and develops themes and motifs across your script, from identification to feedback. |
| [Se Technical Writer](../it-and-development/writing-and-content/se-technical-writer.md) | Transforms complex technical concepts into clear, engaging developer documentation and educational content. |
| [Seo Aeo Blog Writer](../marketing/writing-and-content/seo-aeo-blog-writer.md) | Write structured blog posts optimized for SEO ranking and AI extraction. |
...
| [Seo Content](../marketing/writing-and-content/seo-content.md) | Audit content quality and E-E-A-T signals for SEO and AI citation readiness. |
| [Seo Content Auditor](../marketing/writing-and-content/seo-content-auditor.md) | Analyzes content for E-E-A-T, readability, and SEO quality, scoring it and recommending improvements. |
| [SEO Content Optimizer](writing-and-content/seo-content-optimizer.md) | Optimizes content for search engines through keyword research, on-page fixes, and reporting. |
...
| [Technical Manual Writing Assistant](writing-and-content/technical-manual-writing-assistant.md) | Draft, structure, and refine technical manuals from research to final review. |
...
| [Seo Authority Builder](../marketing/marketing-and-growth/seo-authority-builder.md) | Audit content for E-E-A-T signals and build topical authority. |
...
| Template | What it does |
|---|---|
| [Code Documentation Doc Generate](../it-and-development/coding/code-documentation-doc-generate.md) | Generate API docs, architecture diagrams, and user guides from code. |
...
| Template | What it does |
|---|---|
| [Blogger Legal Compliance Guide](security-and-compliance/blogger-legal-compliance-guide.md) | Guides bloggers through legal and ethical compliance for content, disclosures, and privacy. |
...
| Template | What it does |
|---|---|
| [Instructional Design Assistant](teaching-and-tutoring/instructional-design-assistant.md) | Designs instructional content, assessments, and learning experiences from research to evaluation. |
...
| Template | What it does |
|---|---|
| [Prompt Library](prompt-engineering/prompt-library.md) | Curated prompt templates for coding, writing, analysis, and creative tasks. |
...
| Template | What it does |
|---|---|
| [Comment Moderation Assistant](support-and-community/comment-moderation-assistant.md) | Moderate blog comments efficiently while keeping your community safe and engaged. |

## Translation

| Template | What it does |
|---|---|
| [Humanize Chinese](translation/humanize-chinese.md) | Detect and rewrite AI-like Chinese text to sound natural, reduce AIGC, or match a target style. |
...
[← All job fields](../../README.md#browse-by-job) · [Writers on the website](https://templatesgrokbot.com/jobs/writers)
