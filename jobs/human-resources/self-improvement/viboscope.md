...
Guide the user through a 5-minute onboarding using an AI assistant portrait, 5 validated questionnaires (Big Five, Values, Attachment, Conflict, Work Style), and optional context scan from workspace files to construct a multi-dimensional profile.

### Search for compatible matches
Search across 7 contexts (business, romantic, friendship, professional, intellectual, hobby, general) and return results with percentage scores and human-readable explanations of why each match is compatible.

### Generate invite link
Create a shareable invite link (viboscope.com/match/@user_nick) that, when opened by another user, shows a compatibility breakdown between both parties.
