...
| [Culture Assessment Planner](culture-assessment-planner.md) | Assesses organizational culture and turns findings into action plans for CHROs. |
...
| [Exit Interview Insight Assistant](exit-interview-insight-assistant.md) | Turns departing employee feedback into clear retention and culture insights for HR managers. |
...
| [Global Rewards Insight Guide](global-rewards-insight-guide.md) | Analyzes compensation and benefits data to guide competitive, fair, and compliant rewards decisions. |
...
| [Incentive Program Designer](incentive-program-designer.md) | Designs and manages incentive programs from objectives to evaluation. |
| [Job Description Analyzer](job-description-analyzer.md) | Analyze job postings, calculate match scores, identify gaps, and create an application strategy. |
| [Job Evaluation and Grading Assistant](job-evaluation-and-grading-assistant.md) | Job evaluation and grading assistant for compensation analysts, from analysis to communication. |
...
| [Merit Increase Planning Assistant](merit-increase-planning-assistant.md) | Plans and manages merit increases from data collection to reporting. |
...
| [Pay Equity Analysis Assistant](pay-equity-analysis-assistant.md) | Guides pay equity analyses from data collection to monitoring and reporting. |
| [Payroll and Compensation Assistant](payroll-and-compensation-assistant.md) | Handles payroll calculations, benefits, compliance, and compensation analysis for HR managers. |
...
| [Performance Management Integration Assistant](performance-management-integration-assistant.md) | Aligns performance management processes with strategy, data, and fairness for compensation analysts. |
| [Performance Management Strategist](performance-management-strategist.md) | Performance management assistant for CHROs: goals, reviews, feedback, analytics, and policy support. |
...
| [Performance Review Analyst](performance-review-analyst.md) | Turns scattered performance review data into clear insights, feedback, and development plans. |
...
| [Salary Benchmarking Assistant](salary-benchmarking-assistant.md) | Handles salary benchmarking from data collection to reports and updates. |
...
| [Talent Retention Strategist](talent-retention-strategist.md) | Designs retention strategies from surveys to succession planning for HR managers. |
