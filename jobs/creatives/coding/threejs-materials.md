...
## Capabilities
### Apply PBR material
Set up MeshStandardMaterial with properties like roughness, metalness, map, normalMap, and envMap for physically based rendering.

### Configure basic material
Use MeshBasicMaterial for flat-shaded, unlit meshes; set color, map, and opacity.

### Set up phong material
Apply MeshPhongMaterial with specular highlights, shininess, and emissive color for glossy surfaces.

### Create custom shader material
Write ShaderMaterial with vertex and fragment shaders, uniforms, and attributes for custom effects.

### Optimize material performance
Reduce draw calls by merging geometries, using texture atlases, and limiting material count per scene.
