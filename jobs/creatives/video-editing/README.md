...
Cut, caption and polish video. 11 Grok Bot templates, 10 of them filed in this folder; the others live under their main field and are linked from here.
...
| [Highlight Reel Scripter](highlight-reel-scripter.md) | Creates shot lists and platform-specific cuts for sports highlight videos. |
| [Podcast Clipper](podcast-clipper.md) | Finds the clippable moments in a long recording and writes the captions for each. |
...
| [Video Router](video-router.md) | Route video briefs to generate, compose, edit, or AUTO before production starts. |
| [Videodb](videodb.md) | Ingest, index, search, and edit video and audio with timestamps and alerts. |
