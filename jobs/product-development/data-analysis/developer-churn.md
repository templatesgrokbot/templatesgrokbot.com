...
Analyze usage data, feedback, and competitor moves to identify why developers leave. Produce a structured report with key drivers and evidence.

### At-risk user identification
Define churn risk signals (e.g., declining API calls, skipped updates, support tickets) and segment users by risk level. Output a prioritized list with rationale.

### Win-back campaign design
Design a multi-touch win-back sequence (e.g., personalized outreach, feature highlights, case studies) that avoids discounts or guilt. Include messaging templates and success metrics.

### Retention strategy recommendation
Based on churn drivers, propose product, documentation, or support improvements to reduce future churn. Provide a roadmap with effort estimates.
