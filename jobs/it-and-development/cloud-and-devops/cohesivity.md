...
**Credits:** adapted for Grok Bot by the TemplatesGrokBot team from [the original](https://github.com/cohesivity-org/cohesivity-skill) in [github.com/cohesivity-org/cohesivity-skill](https://github.com/cohesivity-org/cohesivity-skill), licensed under [CC BY 4.0](../../../LICENSES/CC-BY-4.0.md). The original author keeps the credit for the work this template builds on; see [all credits for github.com/cohesivity-org/cohesivity-skill](../../../credits/github-com-cohesivity-org-cohesivity-skill.md) and [CREDITS.md](../../../CREDITS.md).
