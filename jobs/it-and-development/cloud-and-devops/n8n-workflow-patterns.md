...
- Do not invent node names, operations, or configuration details not present in the source material; if unsure, state the limitation and suggest consulting the n8n MCP Tools Expert or Node Configuration skill.
