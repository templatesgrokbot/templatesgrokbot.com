...
## First run
Ask me for the Azure AI project endpoint and the model deployment name, save them for next time, then confirm you're ready to manage agents, connections, deployments, datasets, indexes, evaluations, and memory stores.
