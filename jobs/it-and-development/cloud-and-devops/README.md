...
| [Antigravity Maintainer Batch Release](antigravity-maintainer-batch-release.md) | Protected AAS maintainer sweeps, PR merge batches, and scripted releases for repository maintenance. |
| [Api Analyzer](api-analyzer.md) | Validates API requests in one line — checks method, URL, headers, body, auth, and query params. |
| [Api Design Principles](api-design-principles.md) | Designs or reviews REST and GraphQL APIs for clarity, scalability, and developer usability. No implementation or infrastructure work. |
| [Api Integration](api-integration.md) | Designs event-driven architectures, webhook systems, and API integration patterns between services. No implementation or deployment. |
...
| [AWS Essentials](aws-skills.md) | Guide AWS infrastructure automation and cloud architecture patterns. |
| [Aws Mcp Setup](aws-mcp-setup.md) | Configure AWS MCP servers for documentation search and API access. |
| [Aws Secrets Rotation](aws-secrets-rotation.md) | Automate AWS secrets rotation for RDS, API keys, and credentials using Lambda. |
...
| [Azure Ai Projects Ts](azure-ai-projects-ts.md) | Manage Azure AI Foundry agents, connections, deployments, and evaluations via TypeScript SDK. No model training or deployment orchestration. Hand off. |
...
| [Azure Functions](azure-functions.md) | Guides Azure Functions patterns, anti-patterns, and sharp edges without writing code. |
| [Azure Iac Exporter](azure-iac-exporter.md) | Export Azure resources to IaC templates (Bicep, ARM, Terraform, Pulumi). |
| [Azure Iac Generator](azure-iac-generator.md) | Generates production-ready Infrastructure as Code across Bicep, ARM, Terraform, and Pulumi. |
...
| [Azure Mgmt Apimanagement Py](azure-mgmt-apimanagement-py.md) | Manage Azure API Management services, APIs, products, and policies via Python SDK. |
| [Azure Mgmt Applicationinsights Dotnet](azure-mgmt-applicationinsights-dotnet.md) | Manage Azure Application Insights resources for APM and observability. |
| [Azure Mgmt Arizeaiobservabilityeval Dotnet](azure-mgmt-arizeaiobservabilityeval-dotnet.md) | Manage Arize AI Observability & Evaluation organizations on Azure via .NET SDK. |
| [Azure Mgmt Botservice Dotnet](azure-mgmt-botservice-dotnet.md) | Provision and manage Azure Bot Service resources via .NET SDK. |
| [Azure Mgmt Fabric Dotnet](azure-mgmt-fabric-dotnet.md) | Provision and manage Microsoft Fabric capacities via Azure Resource Manager SDK in .NET. |
| [Azure Mgmt Fabric Py](azure-mgmt-fabric-py.md) | Manage Microsoft Fabric capacities and resources via Azure SDK. |
| [Azure Mgmt Mongodbatlas Dotnet](azure-mgmt-mongodbatlas-dotnet.md) | Manage MongoDB Atlas organizations as Azure ARM resources with unified billing. |
| [Azure Mgmt Weightsandbiases Dotnet](azure-mgmt-weightsandbiases-dotnet.md) | Manage Weights & Biases ML instances on Azure via .NET SDK. |
| [Azure Monitor Ingestion Java](azure-monitor-ingestion-java.md) | Send custom logs to Azure Monitor via Data Collection Rules and Endpoints. |
| [Azure Monitor Ingestion Py](azure-monitor-ingestion-py.md) | Send custom logs to Azure Monitor Log Analytics using the Logs Ingestion API. |
...
| [Azure Resource Manager Mysql Dotnet](azure-resource-manager-mysql-dotnet.md) | Manage Azure MySQL Flexible Server deployments with the .NET SDK. |
| [Azure Resource Manager Playwright Dotnet](azure-resource-manager-playwright-dotnet.md) | Provision and manage Playwright Testing workspaces via Azure Resource Manager. |
| [Azure Resource Manager Postgresql Dotnet](azure-resource-manager-postgresql-dotnet.md) | Manage Azure PostgreSQL Flexible Server deployments via .NET SDK. |
| [Azure Resource Manager Redis Dotnet](azure-resource-manager-redis-dotnet.md) | Provision and manage Azure Cache for Redis resources via Azure Resource Manager |
| [Azure Resource Manager Sql Dotnet](azure-resource-manager-sql-dotnet.md) | Provision and manage Azure SQL resources via .NET ARM SDK. |
| [Azure Saas Architect](azure-saas-architect.md) | Design multitenant Azure SaaS architectures using Well-Architected principles. |
| [Azure Security Keyvault Secrets Java](azure-security-keyvault-secrets-java.md) | Manage Azure Key Vault secrets (passwords, API keys, connection strings) using the Java SDK. Store, retrieve, update, list, delete, recover, backup, a |
| [Azure Servicebus Py](azure-servicebus-py.md) | Send and receive messages via Azure Service Bus queues, topics, and subscriptions. |
| [Azure Storage Blob Py](azure-storage-blob-py.md) | Manage Azure Blob Storage: upload, download, list, delete blobs and containers. |
| [Azure Storage File Datalake Py](azure-storage-file-datalake-py.md) | Manage Azure Data Lake Storage Gen2 files and directories with Python SDK. |
...
| [Deploy To Vercel](deploy-to-vercel.md) | Deploy projects to Vercel as previews and set up git-push deploys. |
| [Deployment](deployment.md) | Manages Railway deployment lifecycle: view logs, redeploy, restart, or take down deployments. |
...
| [Devops Expert](devops-expert.md) | Guides teams through the full DevOps lifecycle with automation, collaboration, and continuous improvement. |
...
| [Error Diagnostics Error Trace](error-diagnostics-error-trace.md) | Implement error tracking, structured logging, and intelligent alerting for production systems. |
...
| [Git Workflow And Versioning](git-workflow-and-versioning.md) | Structures git workflow for safe, reviewable code changes. |
| [Github Actions Advanced](github-actions-advanced.md) | Design, debug, and secure production-grade GitHub Actions workflows. |
| [Github Actions Creator](github-actions-creator.md) | Generates production-ready GitHub Actions workflow files from project analysis. |
| [Github Actions Debugger](github-actions-debugger.md) | Diagnose and fix failing GitHub Actions workflows by parsing logs and pipeline definitions. |
| [Github Actions Expert](github-actions-expert.md) | Designs and secures GitHub Actions workflows with least privilege and supply-chain safety. |
| [GitHub Actions Saver](github-actions-saver.md) | Diagnoses GitHub Actions minute limits, sets a budget, and slims down workflows to cut CI costs. |
| [Github Actions Templates](github-actions-templates.md) | Generates production-ready GitHub Actions YAML workflows for CI/CD pipelines. |
| [Github Workflow Automation](github-workflow-automation.md) | Generate GitHub Actions workflows for PR review, issue triage, and CI/CD. |
| [Gitlab Automation](gitlab-automation.md) | Automate GitLab project management, issues, MRs, pipelines, branches, and users via Composio. |
| [Gitlab Ci Patterns](gitlab-ci-patterns.md) | Generate GitLab CI/CD pipeline YAML with caching, security, and deployment patterns. |
| [Gitops Workflow](gitops-workflow.md) | Configures GitOps pipelines for Kubernetes with ArgoCD or Flux. |
| [Gke Basics](gke-basics.md) | Plans and configures production-ready GKE Autopilot clusters with golden path defaults. |
| [Google Cloud Auth](google-cloud-auth.md) | Guides authentication and authorization for Google Cloud services and APIs. |
...
| [Hubspot Integration](hubspot-integration.md) | Guide HubSpot CRM integration with OAuth, CRUD, batch, webhooks, and custom objects. |
...
| [Mailtrap Setting Up Sending Domain](mailtrap-setting-up-sending-domain.md) | Add or verify a Mailtrap sending domain, publish SPF/DKIM/DMARC, and complete compliance. |
...
| [Neon Migration Specialist](neon-migration-specialist.md) | Safely test and apply Postgres schema changes using Neon branching, with zero-downtime. |
...
| [Observability Monitoring Slo Implement](observability-monitoring-slo-implement.md) | Implement SLO frameworks and error budgets for service reliability. |
| [Observability Phoenix](observability-phoenix.md) | Self-hosted AI observability for tracing, evaluating, and monitoring LLM applications. |
| [Odoo Backup Strategy](odoo-backup-strategy.md) | Backup and restore Odoo databases and filestores with automated scripts. |
...
| [Postmortem Writing](postmortem-writing.md) | Guide blameless postmortems from incident data to action items. |
| [Power Platform Expert](power-platform-expert.md) | Provides expert guidance on Power Platform development, architecture, and best practices. |
| [Powershell 5.1 Expert](powershell-5-1-expert.md) | Generates safe, auditable PowerShell 5.1 scripts for Windows infrastructure automation. |
| [Powershell 7 Expert](powershell-7-expert.md) | Builds cross-platform PowerShell 7 automation for cloud, CI/CD, and enterprise operations. |
| [Pre Release Review](pre-release-review.md) | Read-only pre-release review for deploy readiness, migrations, config, secrets, rollout order, rollback risk, and launch blockers. |
...
| [Setup Matt Pocock Templates](setup-matt-pocock-skills.md) | Configure a repo's issue tracker, triage labels, and domain docs for engineering capabilities. |
...
| [Terraform Engineer](terraform-engineer.md) | Designs and implements reusable Terraform modules with enterprise state management and CI/CD integration. |
| [Terraform Infrastructure](terraform-infrastructure.md) | Provision and manage cloud infrastructure with Terraform, safely and repeatably. |
...
| [Vercel Cli With Tokens](vercel-cli-with-tokens.md) | Deploy and manage Vercel projects using token-based authentication. |
| [Vercel Deploy](vercel-deploy.md) | Deploys projects to Vercel as preview or production. |
