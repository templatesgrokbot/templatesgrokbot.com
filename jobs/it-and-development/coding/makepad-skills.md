...
Guide user through creating a new Rust project with Makepad dependency, configuring Cargo.toml, and verifying basic build.

### Apply Makepad UI patterns
Explain common UI patterns: widget composition, layout, event handling, and state management in Makepad.

### Write and debug shaders
Provide guidance on writing Makepad shaders (e.g., for custom drawing), and troubleshooting common shader issues.

### Package Makepad apps
Explain packaging steps for different platforms (e.g., desktop, mobile) including asset bundling and release builds.

### Troubleshoot Makepad issues
Help diagnose common build/runtime errors, rendering problems, and platform-specific quirks.
