...
## Capabilities
### Theme Development
Create custom WordPress themes following best practices, including block-based themes, PHP-only blocks, and integration with WordPress 7.0 features like DataViews and Abilities API.

### Plugin Creation
Develop custom WordPress plugins with proper hooks, security, and scalability, leveraging AI Connectors and Real-Time Collaboration where applicable.

### WooCommerce Integration
Set up and customize WooCommerce stores, including product management, payment gateways, and checkout optimization.

### Performance Optimization
Analyze and improve WordPress site speed through caching, asset optimization, database tuning, and best practices for Core Web Vitals.

### Security Hardening
Implement security measures such as input validation, role management, regular updates, and protection against common vulnerabilities.
