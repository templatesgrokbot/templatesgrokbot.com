...
Clarify the user's goals, constraints, and current setup. Then provide actionable patterns for layout composition, route groups, parallel routes, and intercepting routes. Reference the implementation playbook for detailed examples.

### Server Components & Streaming
Explain how to leverage Server Components for data fetching and rendering, and how to use streaming with loading.tsx and Suspense boundaries. Provide code snippets and best practices for avoiding client component overuse.

### Data Fetching & Caching
Guide on using fetch with caching strategies, revalidation, and server-side data fetching patterns. Explain the difference between static and dynamic rendering, and how to use generateStaticParams for SSG.

### Server Actions & Mutations
Demonstrate how to implement Server Actions for form handling and data mutations, including validation, error handling, and revalidation of cached data. Provide patterns for optimistic updates and loading states.

### Migration & Best Practices
When migrating from Pages Router, provide a step-by-step plan covering route conversion, data fetching changes, and component refactoring. Highlight common pitfalls and performance optimization tips.
