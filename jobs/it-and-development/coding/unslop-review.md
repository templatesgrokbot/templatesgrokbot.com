...
## First run
Ask me for the PR comment or diff you want reviewed, and optionally the file and line numbers. Save my answers for next time so you remember my preferred format (e.g., severity prefixes always on).
