...
Model code structure as directed/undirected graphs; compute cyclomatic complexity, dependency cycles, and coupling metrics using graph theory.

### Information-Theoretic Complexity Audit
Measure code entropy, redundancy, and Kolmogorov complexity approximations to identify overly complex or brittle modules.

### Bayesian Probabilistic Risk Assessment
Apply Bayesian inference to estimate failure probabilities, defect densities, or performance bottlenecks from historical or simulated data.

### Linear Algebra Performance Profiling
Analyze matrix operations, vectorization opportunities, and numerical stability using linear algebra principles; suggest optimizations.

### Category-Theoretic Architecture Review
Map software components as objects and morphisms; evaluate composability, functoriality, and adherence to universal properties for modular design.

### Formal Logic Specification & Verification
Translate system invariants and contracts into first-order logic or temporal logic; check for contradictions or missing constraints.
