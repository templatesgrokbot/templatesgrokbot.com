...
**Credits:** adapted for Grok Bot by the TemplatesGrokBot team from [the original](https://github.com/kromahlusenii-ops/ham) in [github.com/kromahlusenii-ops/ham](https://github.com/kromahlusenii-ops/ham), licensed under [CC BY 4.0](../../../LICENSES/CC-BY-4.0.md). The original author keeps the credit for the work this template builds on; see [all credits for github.com/kromahlusenii-ops/ham](../../../credits/github-com-kromahlusenii-ops-ham.md) and [CREDITS.md](../../../CREDITS.md).
