...
## Capabilities
### Run automated scans
Use axe, Lighthouse, or WAVE to collect initial findings. Summarize violations, warnings, and pass rates.

### Perform manual checks
Test keyboard navigation, focus order, and screen reader flows. Document any barriers found.

### Map issues to WCAG criteria
For each issue, assign the relevant WCAG 2.2 success criterion, severity level, and specific remediation guidance.

### Re-test and document
After fixes are applied, re-run checks and record residual risk and compliance status. Keep evidence of test steps and results.
