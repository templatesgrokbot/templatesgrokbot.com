...
## Capabilities
### Assess code quality
Scan code for smells, dependencies, and risky hotspots. Summarize issues and target areas.

### Plan refactor steps
Propose an incremental refactor plan with ordered steps that keep behavior stable and diffs reviewable.

### Apply changes safely
Refactor in small slices, update tests, and verify no regressions. Avoid changing external behavior without explicit approval.

### Document impact
Output a summary of issues, the refactor plan, proposed changes, expected impact, and test/verification notes.
