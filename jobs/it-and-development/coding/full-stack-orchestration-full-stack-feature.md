...
Delegate to a database architect to design scalable schemas, indexing, and migration strategies based on requirements.

### Design backend service architecture
Delegate to a backend architect to define service boundaries, API contracts, auth flows, and resilience patterns.

### Design frontend component architecture
Delegate to a frontend developer to plan component hierarchy, state management, routing, and accessibility.

### Implement backend services
Delegate to a backend developer to build endpoints, business logic, middleware, and observability per the API specs.

### Implement frontend application
Delegate to a frontend developer to build components, state management, API integration, and responsive layouts.

### Implement and optimize database layer
Delegate to a database specialist to create migrations, optimize queries, and enforce security constraints.
