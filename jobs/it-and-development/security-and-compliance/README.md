...
| [Api Security Audit](api-security-audit.md) | Audits REST APIs for security vulnerabilities and compliance gaps. |
| [Api Security Best Practices](api-security-best-practices.md) | Guide developers in building secure APIs with authentication, validation, and protection patterns. |
| [Api Security Testing](api-security-testing.md) | Guided API security assessment for REST and GraphQL endpoints. |
| [API Version Diff Auditor](api-version-diff-auditor.md) | Enumerate and diff old and current API versions to find security regressions. |
...
| [Aws Security Audit](aws-security-audit.md) | Audit AWS security posture for misconfigurations and vulnerabilities. Report findings only. |
| [Azure Ai Contentsafety Ts](azure-ai-contentsafety-ts.md) | Analyze text and images for harmful content with customizable blocklists. |
| [Azure Security Keyvault Keys Dotnet](azure-security-keyvault-keys-dotnet.md) | Manage Azure Key Vault keys: create, rotate, encrypt, decrypt, sign, and verify with .NET. |
| [Backend Security Coder](backend-security-coder.md) | Secure backend coding expert for input validation, authentication, and API security. |
| [Broken Authentication](broken-authentication.md) | Guide systematic testing of authentication and session vulnerabilities. |
| [Browser Extension Reverse](browser-extension-reverse.md) | Authorized reverse engineering of browser extensions for security research. |
| [Brute Force Hunter](brute-force-hunter.md) | Hunts missing or weak rate limiting, brute force, and user enumeration in web apps. |
| [Bug Bounty Report Writer](bug-bounty-report-writer.md) | Write impact-first bug bounty reports for H1, Bugcrowd, Intigriti, and Immunefi. |
| [Bug Bounty Workflow Guide](bug-bounty-workflow-guide.md) | Guided bug bounty hunting from recon to validated report. |
| [Bugcrowd Submission Assistant](bugcrowd-submission-assistant.md) | Files Bugcrowd submissions with VRT fallback, severity overrides, and OOS rebuttals. |
| [Bumblebee](bumblebee.md) | Run read-only supply-chain scans for compromised packages and extensions on macOS/Linux. |
| [Burp Suite Testing](burp-suite-testing.md) | Guide web app security testing with Burp Suite proxy, repeater, and scanner. |
| [Burpsuite Project Parser](burpsuite-project-parser.md) | Extract and search Burp Suite project files from the command line. |
| [Business Logic Hunter](business-logic-hunter.md) | Hunts business logic vulnerabilities in web apps, focusing on financial-impact cases. |
...
| [Cybersecurity Assessment Assistant](cybersecurity-assessment-assistant.md) | Cybersecurity assessment assistant for IT consultants, covering scans, reviews, and planning. |
...
| [Cybersecurity Policy and Risk Assistant](cybersecurity-policy-and-risk-assistant.md) | Cybersecurity policy, risk, and incident management support for technology managers. |
...
| [Cybersecurity Threat Analyst](cybersecurity-threat-analyst.md) | Cybersecurity threat analysis and defense planning for network administrators. |
| [Cybersecurity Trend Analyst](cybersecurity-trend-analyst.md) | Tracks cybersecurity trends and turns them into threat, risk, and policy guidance for your organization. |
...
| [Gdpr Data Handling](gdpr-data-handling.md) | Guide GDPR-compliant data processing, consent, and subject requests. |
| [Gha Security Review](gha-security-review.md) | Find exploitable vulnerabilities in GitHub Actions workflows with concrete attack paths. |
| [Google Cloud Waf Security](google-cloud-waf-security.md) | Evaluates Google Cloud workloads against the Well-Architected Framework security pillar and gives actionable recommendations. |
...
| [Metasploit Framework](metasploit-framework.md) | Guide penetration testing with Metasploit from reconnaissance to post-exploitation. |
| [MFA Bypass Hunter](mfa-bypass-hunter.md) | Hunts MFA/2FA bypasses across 7 patterns and chains them toward account takeover. |
...
| [Network Policy Enforcement Assistant](network-policy-enforcement-assistant.md) | Drafts, implements, and monitors network policies for compliance and security. |
| [Network Security Advisor](network-security-advisor.md) | Security protocol recommendations and audits for network administrators. |
...
| [Network Security Audit Planner](network-security-audit-planner.md) | Audits network security and drafts remediation plans for IT managers. |
...
| [Penetration Tester](penetration-tester.md) | Conduct authorized penetration tests to identify and validate exploitable vulnerabilities. |
| [Pentest Checklist](pentest-checklist.md) | Guide users through a structured pentest checklist from scope to remediation. |
...
| [Pwn Chain](pwn-chain.md) | Turn a known binary vulnerability into a working exploit for CTF or authorized targets. |
...
| [Race Condition Hunter](race-condition-hunter.md) | Hunt and verify race condition vulnerabilities in web applications. |
| [Radare2](radare2.md) | Analyze binaries via radare2 CLI: recon, disassemble, locate functions, patch without GUI. |
| [Radio Sdr](radio-sdr.md) | Authorized SDR security research: signal identification, replay feasibility, and wireless protocol analysis. |
| [RAG Vector Weakness Hunter](rag-vector-weakness-hunter.md) | Hunt vector-store and embedding-layer weaknesses in RAG pipelines, with proof gates. |
| [Read Only Auditor](read-only-auditor.md) | Audits code for security issues without making any changes. |
| [Recon Scope Triage](recon-scope-triage.md) | Triage ASM/recon output to separate the target's real assets from same-name noise before testing. |
| [Red Team Operator Discipline](red-team-operator-discipline.md) | Keeps red-team coverage relentless while respecting the data-minimization boundary. |
...
| [Security Best Practices Assistant](security-best-practices-assistant.md) | Guides software engineers through security practices, from code review to incident response. |
...
| [Security Tool Customization Assistant](security-tool-customization-assistant.md) | Customizes security tools to fit your organization's needs and documents the work. |
...
| [Security Vulnerability Assessment Assistant](security-vulnerability-assessment-assistant.md) | Finds, assesses, and tracks security vulnerabilities across code, networks, and policies. |
...
| [SQL Injection Hunter](sql-injection-hunter.md) | Hunt SQL injection vulnerabilities across web applications and APIs. |
| [Sql Injection Testing](sql-injection-testing.md) | Tests web applications for SQL injection vulnerabilities and documents findings. |
| [Sqlmap Database Pentesting](sqlmap-database-pentesting.md) | Guides SQL injection testing with sqlmap commands for authorized assessments only. |
| [Src Hunter](src-hunter.md) | Five-phase bug-bounty hunting workflow with 19 attack playbooks and 305 structured payloads. |
| [Ssh Penetration Testing](ssh-penetration-testing.md) | Audit SSH services for weak configs, credentials, and tunneling risks with step-by-step guidance. |
| [SSRF Hunter](ssrf-hunter.md) | Hunts and confirms SSRF vulnerabilities on authorized targets with OOB validation. |
| [SSTI Hunter](ssti-hunter.md) | Hunt server-side template injection and escalate to command execution across web apps. |
| [Stackhawk Security Onboarding](stackhawk-security-onboarding.md) | Automatically set up StackHawk security testing for a repository with generated configuration and GitHub Actions workflow. |
| [Stride Analysis Patterns](stride-analysis-patterns.md) | Systematic threat identification using STRIDE methodology for security analysis. |
| [Subdomain Takeover Hunter](subdomain-takeover-hunter.md) | Hunt and verify subdomain takeover vulnerabilities with provider fingerprints. |
| [Supply Chain Guard](supply-chain-guard.md) | Scan project dependencies for known supply chain attacks and guide remediation. |
...
| [Systems Analyst Security Assistant](systems-analyst-security-assistant.md) | Security assessment assistant for systems analysts covering scans, reviews, and response planning. No hype, no emoji. |
| [Technology Compliance Manager](technology-compliance-manager.md) | Tracks regulations, drafts policies, and prepares audits for technology compliance managers. |
...
| [Thick Client](thick-client.md) | Authorized security testing of desktop thick clients: local storage, update channels, IPC, traffic interception, and client-side trust-boundary review |
| [Threat Hunting](threat-hunting.md) | Proactive threat hunting and detection engineering with Sigma, YARA, and SIEM queries. |
| [Threat Intelligence Analyst](threat-intelligence-analyst.md) | Gathers, analyzes, and prioritizes cyber threat intelligence for your organization's defense. |
| [Threat Mitigation Mapping](threat-mitigation-mapping.md) | Map threats to security controls for prioritized remediation and coverage validation. |
| [Threat Modeling Expert](threat-modeling-expert.md) | Analyze system architecture to identify threats and recommend mitigations. |
...
| [Vendor Security Assessment Assistant](vendor-security-assessment-assistant.md) | Assesses vendor security risks, compliance, and readiness for InfoSec analysts. |
...
| [WebSocket Security Auditor](websocket-security-auditor.md) | Hunt WebSocket vulnerabilities: CSWSH, weak auth, tampering, and smuggling. |
| [Wg Code Sentinel](wg-code-sentinel.md) | Review code for security vulnerabilities and recommend fixes. |
