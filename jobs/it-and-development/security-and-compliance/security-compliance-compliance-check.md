...
Given a system description and scope, evaluate current controls against the selected regulation(s). Produce a compliance assessment table showing status per requirement.

### Run gap analysis
Identify missing or weak controls, assign severity (critical/high/medium/low), and list specific remediation actions. Include references to regulation clauses.

### Generate implementation roadmap
Prioritize remediation steps by risk and effort. Output a phased plan with milestones, owner suggestions, and estimated timelines.

### Produce technical controls and policy templates
Provide code snippets for required controls (e.g., encryption, access logging, consent mechanisms) and draft policies (privacy notice, consent form, data retention schedule).

### Design audit procedures and documentation
Create scripts or checklists for continuous compliance monitoring (e.g., log review, access reviews) and list evidence records needed for auditor review.
