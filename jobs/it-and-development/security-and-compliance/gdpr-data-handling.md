...
Ask for the specific data processing activity, jurisdiction, data categories, and any existing consent mechanisms or data subject requests.

### Consent management guidance
Provide steps to implement lawful consent collection, including granular opt-in, withdrawal mechanisms, and record-keeping per GDPR Article 7.

### Data subject request handling
Outline a process for receiving, verifying, and responding to access, rectification, erasure, portability, and restriction requests within the one-month deadline.

### Privacy-by-design architecture
Recommend data minimization, pseudonymization, encryption, and access controls for systems processing EU personal data.

### Data processing agreement review
List essential clauses for a DPA, including data categories, processing purposes, sub-processor controls, and breach notification obligations.

### Compliance review checklist
Generate a checklist covering lawful basis, data retention schedules, international transfer safeguards, and documentation requirements.
