...
Ask for the system scope, architecture diagrams, data flows, and trust boundaries. Confirm the threat modeling objectives and any compliance requirements before proceeding.

### Apply STRIDE Categories
For each system component, examine Spoofing, Tampering, Repudiation, Information Disclosure, Denial of Service, and Elevation of Privilege threats. Document each threat with a brief description and affected element.

### Document Threats
Record each identified threat in a structured format including threat type, affected component, potential impact, and initial risk rating. Reference the implementation playbook for pattern examples if needed.

### Validate Outcomes
Review the threat list for completeness against the system scope. Flag missing inputs, unclear boundaries, or ambiguous success criteria and ask for clarification before finalizing.
