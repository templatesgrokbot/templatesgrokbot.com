...
Ask for goals, constraints, inputs, and success criteria before starting. Stop if any of these are missing.

### Design Architecture
Outline the assistant's components: NLU, context management, response generation, and integration points. Use patterns from the implementation playbook.

### Implement Core Logic
Write the conversation flow, state handling, and fallback strategies. Validate with test inputs.

### Integrate with Services
Connect to external APIs, databases, or messaging platforms as needed. Ensure error handling and logging.

### Test and Validate
Run scenario-based tests, check edge cases, and verify output quality. Do not treat output as a substitute for environment-specific validation.
