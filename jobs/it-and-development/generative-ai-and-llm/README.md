...
| [Amazon Alexa](amazon-alexa.md) | Integrate Amazon Alexa with Claude to build voice capabilities and AWS backend services. |
...
| [Azure Ai Language Conversations Py](azure-ai-language-conversations-py.md) | Implement Conversational Language Understanding with Azure AI CLU Python SDK. |
| [Azure Ai Openai Dotnet](azure-ai-openai-dotnet.md) | Azure OpenAI client for .NET — chat, embeddings, images, audio, and assistants. |
| [Azure Ai Projects Py](azure-ai-projects-py.md) | Build and manage AI agents on Microsoft Foundry with the azure-ai-projects SDK. |
| [Azure Ai Vision Imageanalysis Java](azure-ai-vision-imageanalysis-java.md) | Analyze images with Azure AI Vision: caption, OCR, objects, tags, people, smart crops. |
| [Azure Ai Vision Imageanalysis Py](azure-ai-vision-imageanalysis-py.md) | Analyze images with Azure AI Vision for captions, tags, objects, OCR, and people detection. |
| [Azure Ai Voicelive Java](azure-ai-voicelive-java.md) | Real-time bidirectional voice conversations with AI assistants via WebSocket. |
| [Azure Ai Voicelive Ts](azure-ai-voicelive-ts.md) | Build real-time voice AI apps with Azure AI Voice Live SDK. |
...
| [Context Compression](context-compression.md) | Compress agent conversation history while preserving critical information for task completion. |
| [Context Degradation](context-degradation.md) | Diagnose and mitigate LLM context degradation patterns like lost-in-middle and poisoning. |
| [Context Optimization](context-optimization.md) | Extend limited context windows with compression, masking, caching, and partitioning strategies. |
| [Context Window Management](context-window-management.md) | Manage LLM context windows by summarizing, trimming, and routing content to prevent token overflow. |
...
| [Emerging Techniques Model Merging](emerging-techniques-model-merging.md) | Merge multiple fine-tuned models into one using mergekit, combining their capabilities without retraining. |
| [Emerging Techniques Model Pruning](../../science-and-research/generative-ai-and-llm/emerging-techniques-model-pruning.md) | Prunes LLMs to reduce size and accelerate inference without retraining. |
...
| [Optimization Gguf](optimization-gguf.md) | Converts models to GGUF format and quantizes them for efficient CPU/GPU inference. |
...
| [Post Training Miles](post-training-miles.md) | Guides enterprise RL training for large MoE models using miles, a production fork of slime. |
| [Post Training Openrlhf](post-training-openrlhf.md) | Run RLHF training jobs (PPO, GRPO, DPO) on large models using Ray and vLLM. |
| [Post Training Simpo](post-training-simpo.md) | Aligns LLMs with preference data using SimPO, a reference-free alternative to DPO. |
| [Post Training Slime](post-training-slime.md) | Guides LLM post-training with RL using the slime framework. |
| [Post Training Torchforge](post-training-torchforge.md) | Guides PyTorch-native agentic RL training using Meta's torchforge library. |
| [Post Training Trl Fine Tuning](post-training-trl-fine-tuning.md) | Fine-tune LLMs with reinforcement learning using TRL for alignment and preference optimization. |
| [Post Training Verl](post-training-verl.md) | Guides reinforcement learning post-training of LLMs using the verl library. |
