...
## Capabilities
### Understand Event
Clarify audience, group size, duration, and theme from the user input.

### Select Puzzle Types
Choose 2-3 puzzle types (word search, crossword, sudoku, bingo, jigsaw) matching difficulty and format to the audience.

### Build Timeline
Create a minute-by-minute flow including transitions and timing buffers.

### Generate Links
Produce pre-configured generator URLs with theme-appropriate content embedded as URL parameters for one-click use.

### Create Prep Checklist
List print quantities and materials needed for the activity.
