...
Team leads and project managers. **287 ready-made Grok Bot templates** for this field, grouped by the kind of work they do.
...
| [Accint Commitments](productivity/accint-commitments.md) | Triage open promises and close them with honest verdicts via acc_act(runtime="outcome"). |
| [Agent Organizer](productivity/agent-organizer.md) | Assembles and coordinates multi-agent teams for complex projects by matching capabilities to tasks. |
...
| [Alex](productivity/alex.md) | Turns requirements into a precise, dependency-aware implementation plan. |
| [Alfred](productivity/alfred.md) | Designs and governs your Grok Bot organization to keep it useful and maintainable. |
| [Antigravity Workflows](productivity/antigravity-workflows.md) | Orchestrate multi-step SaaS, security, AI, QA, or DDD workflows with verified checkpoints. |
...
| [Inbox Triage](productivity/inbox-triage.md) | Sorts overnight email into reply-now, read-later, and ignore, then drafts the replies you owe. |
| [Jira](productivity/jira.md) | Manages Jira tickets, sprints, and workflows through natural language with safe approval gates. |
...
| [Kody](productivity/kody.md) | Coordinates priorities across people, projects, and assistants. |
...
| [Planning With Files](productivity/planning-with-files.md) | Manages complex tasks with persistent markdown planning files, tracking phases, findings, and progress. |
...
| [Project Manager](productivity/project-manager.md) | Plans, tracks, and closes complex projects across teams and timelines. Never invents data. Always asks before acting on scope, budget, or risk changes |
...
| [Scrum Master](productivity/scrum-master.md) | Facilitates agile teams, removes impediments, and drives continuous improvement through Scrum ceremonies. |
...
| [Speed](productivity/speed.md) | Launch RSVP speed reader with Spritz-style word-by-word display. |
...
| [Task Decomposition Expert](productivity/task-decomposition-expert.md) | Breaks complex goals into actionable work breakdowns with dependencies and effort estimates. |
...
| [Task Intelligence](productivity/task-intelligence.md) | Pre-task intelligence protocol that activates parallel agents for briefing, estimation, and execution planning. |
| [Task Planner](productivity/task-planner.md) | Creates actionable implementation plans from verified research findings. |
| [Team Collaboration Standup Notes](productivity/team-collaboration-standup-notes.md) | Generate daily standup notes from commits, Jira, and calendar events. |
...
| Template | What it does |
|---|---|
| [Agentflow](../it-and-development/coding/agentflow.md) | Orchestrate autonomous AI development pipelines through your Kanban board. |
...
| [Audit Agent Run Evidence](../it-and-development/coding/audit-agent-run-evidence.md) | Judge whether agent-run traces really support a claimed success without re-executing anything. |
...
| [Brooks Debt](../it-and-development/coding/brooks-debt.md) | Assess tech debt, classify risks, and prioritize refactoring using classic engineering principles. |
| [Code Refactoring Tech Debt](../it-and-development/coding/code-refactoring-tech-debt.md) | Identify, quantify, and prioritize technical debt from code and change history. |
| [Codebase Cleanup Tech Debt](../it-and-development/coding/codebase-cleanup-tech-debt.md) | Analyze code and change history to find, quantify, and prioritize technical debt with actionable remediation plans. |
| [Codex Delegate](../it-and-development/coding/codex-delegate.md) | Delegate bounded coding tasks to OpenAI Codex CLI, review diffs, and commit yourself. |
| [Comprehensive Code Review Orchestrator](../it-and-development/coding/comprehensive-review-full-review.md) | Orchestrate multi-agent code review across quality, security, performance, testing, and docs. |
| [Conductor Implement](../it-and-development/coding/conductor-implement.md) | Execute tasks from a track's implementation plan following TDD workflow. |
...
| [Dos Verify Done Claims](../it-and-development/coding/dos-verify-done-claims.md) | Verify agent done-claims against git ground truth, not self-report. |
| [Dx Optimizer](../it-and-development/coding/dx-optimizer.md) | Analyzes and improves developer build times, feedback loops, and satisfaction metrics. No hype, no emoji, no 'leverage'/'empower'/'seamless'. |
| [Executing Plans](../it-and-development/coding/executing-plans.md) | Execute implementation plans in batches with review checkpoints. |
| [Framework Migration Legacy Modernize](../it-and-development/coding/framework-migration-legacy-modernize.md) | Orchestrate legacy system modernization using the strangler fig pattern with gradual replacement and continuous operations. |
...
| [Git Workflow Manager](../it-and-development/coding/git-workflow-manager.md) | Designs and optimizes Git workflows, branching strategies, and merge management for teams. |
...
| [Grok Delegate](../it-and-development/coding/grok-delegate.md) | Hand bounded coding tasks to Grok Build CLI, review, and commit yourself. |
...
| [Mentor](../it-and-development/coding/mentor.md) | Challenge an engineer's assumptions and guide them to optimal solutions through critical questioning. |
...
| [Tokenwise](../it-and-development/coding/tokenwise.md) | Routes model tiers by task class with cost logging and A/B verification. |
...
| [Vibe Delegate](../it-and-development/coding/vibe-delegate.md) | Orchestrate coding tasks by delegating to Mistral Vibe CLI and reviewing its output. |
...
| [Project State Governor](knowledge-management/project-state-governor.md) | Govern evidence-backed canonical project state across sessions without inventing intent. |
...
| [It Manager Pro](cloud-and-devops/it-manager-pro.md) | Strategic IT leadership advisor bridging data, finance, and human-centric management. |
...
| [Ceo Advisor](../executives-and-strategy/self-improvement/ceo-advisor.md) | Provide executive leadership guidance for strategic decisions, board preparation, and stakeholder management. |
| [Critical Thinking](../it-and-development/self-improvement/critical-thinking.md) | Challenge assumptions and probe reasoning to find the best solution. |
| [Crossframe Org](self-improvement/crossframe-org.md) | Analyze teams, projects, and organizations to diagnose failures and propose mechanism repairs. |
...
| [Feedback Mastery](self-improvement/feedback-mastery.md) | Prepare, deliver, and follow up on constructive feedback using structured frameworks. |
| [Grill Me](self-improvement/grill-me.md) | A relentless interview that sharpens a plan or design through structured questioning. |
...
| [Morpheus](self-improvement/morpheus.md) | Analyzes options and makes decisions when you are stuck between choices. |
...
| [Ultimate Transparent Thinking Beast Mode](self-improvement/ultimate-transparent-thinking-beast-mode.md) | Thinks through problems step by step with full transparency and never stops until done. No shortcuts. No partial work. No asking permission. Just rele |
| [Viboscope](../human-resources/self-improvement/viboscope.md) | Match with compatible people using validated psychometrics. |
...
[← All job fields](../../README.md#browse-by-job) · [Management on the website](https://templatesgrokbot.com/jobs/management)
