# Generative Code templates for Management

Scaffold apps, components and whole projects from a brief. 5 Grok Bot templates, 1 of them filed in this folder; the others live under their main field and are linked from here.
...
| [Team Dashboard Builder](team-dashboard-builder.md) | Turns your team data into an interactive dashboard with charts and CSV export. |
