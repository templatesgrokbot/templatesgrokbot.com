...
Leaders making decisions from the whole picture. **255 ready-made Grok Bot templates** for this field, grouped by the kind of work they do.
...
| [Marketing & Growth](marketing-and-growth/README.md) | 46 |
...
| [CEO Feedback Action Planner](data-analysis/ceo-feedback-action-planner.md) | Turns customer feedback into prioritized insights, trends, and action plans for your business. |
| [CEO Financial Forecaster](data-analysis/ceo-financial-forecaster.md) | Turns your financial data into forecasts, models, and reports for confident decisions. |
| [CEO Supply Chain Optimizer](data-analysis/ceo-supply-chain-optimizer.md) | Optimizes your supply chain with data-driven insights and recommendations. |
...
| [COO Supply Chain Optimizer](data-analysis/coo-supply-chain-optimizer.md) | Optimizes supply chain operations from forecasting to sustainability for COOs. |
...
| [Market Insight Strategist](data-analysis/market-insight-strategist.md) | Turns market data into strategic insights for CEO decisions. |
...
| [Operations Optimization Assistant](data-analysis/operations-optimization-assistant.md) | Optimizes operations end-to-end: analyze processes, data, and risks; suggest improvements; track KPIs. |
...
| Template | What it does |
|---|---|
| [Agent Overview](../science-and-research/research/agent-overview.md) | Coordinates a multi-agent team to produce academic-quality research reports. |
| [Agentfolio](../product-development/research/agentfolio.md) | Discover and compare autonomous AI agents using the AgentFolio directory. |
| [Andruia AI Consultant](research/andruia-ai-consultant.md) | Diagnoses AI projects and outlines the technical roadmap. |
| [Axiom](research/axiom.md) | Audit hidden assumptions in any decision, rank them by risk, and rebuild conclusions from verified premises. |
...
| [Competitor Intelligence Strategist](research/competitor-intelligence-strategist.md) | Tracks competitors and turns their moves into strategic decisions for your company. |
...
| [Product Development Assistant](marketing-and-growth/product-development-assistant.md) | Guides CEOs through product development from market research to launch, using analysis and planning. |
...
| [CEO Sustainability Roadmap Builder](productivity/ceo-sustainability-roadmap-builder.md) | Turns your company's sustainability data into a practical action plan, from assessment to reporting. |
...
| [Innovation Strategy Advisor](productivity/innovation-strategy-advisor.md) | Turns market data and employee ideas into a prioritized, de-risked innovation roadmap for your company. |
...
| [Talent Acquisition Workflow Manager](productivity/talent-acquisition-workflow-manager.md) | Manages your end-to-end talent acquisition workflow, from job posts to onboarding and feedback. |
...
| [Vendor Evaluation Navigator](../it-and-development/sales-and-negotiation/vendor-evaluation-navigator.md) | Guides IT VPs through vendor evaluation, selection, and ongoing management. |
...
| [Cloud Strategy Advisor](../it-and-development/cloud-and-devops/cloud-strategy-advisor.md) | Guides IT directors through cloud strategy, from provider evaluation to governance and optimization. |
...
| [Cybersecurity Management Assistant](../it-and-development/security-and-compliance/cybersecurity-management-assistant.md) | Cybersecurity management assistant for global heads of IT, turning data into defense actions. |
...
| [Ceo Advisor](self-improvement/ceo-advisor.md) | Provide executive leadership guidance for strategic decisions, board preparation, and stakeholder management. |
