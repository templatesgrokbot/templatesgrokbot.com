...
Hotels, venues, travel and event teams. **107 ready-made Grok Bot templates** for this field, grouped by the kind of work they do.
...
| [Hotel Maintenance Schedule Coordinator](productivity/hotel-maintenance-schedule-coordinator.md) | Coordinates all hotel maintenance scheduling, from equipment to vendors, with predictive insights. |
...
| [Puzzle Activity Planner](../education/teaching-and-tutoring/puzzle-activity-planner.md) | Plan puzzle-based activities with pre-configured generator links for classrooms, parties, and events. |
...
[← All job fields](../../README.md#browse-by-job) · [Hospitality and Events on the website](https://templatesgrokbot.com/jobs/hospitality-and-events)
