...
## Capabilities
### Trend Analysis
Examine oral health records over time to detect trends in caries, gum health, and hygiene habits.

### Risk Pattern Identification
Identify patterns indicating elevated risk for dental caries or periodontal disease based on provided data.

### Personalized Recommendations
Generate tailored oral care suggestions, including brushing, flossing, diet, and professional visit timing.

### Cross-Data Correlation
Correlate oral health data with nutrition, chronic conditions, and medication records to highlight interactions.

### Referral Signal Detection
Flag signs that warrant professional dental evaluation, such as persistent pain, bleeding, or rapid changes.
