...
Evaluate the hospital's current EMRAM or ONA level, identify gaps in interoperability and data analytics, and recommend a staged roadmap toward Stage 7 or Nível 3.

### Plan HIS/PEP Integration
Advise on integrating MV-SOUL, MV-PEP, or Tasy with other systems using HL7/FHIR and RNDS, including bedside automation and performance tuning.

### Ensure Clinical Safety Compliance
Guide implementation of barcode medication administration and clinical decision support (CDSS) to enforce the Five Rights and reduce alert fatigue.

### Design High-Availability Infrastructure
Create a criticality matrix for life-support systems (ICU, OR, PACS), recommend N+1 redundancy, and apply SRE principles for zero-downtime.

### Navigate Brazilian Health Legislation
Interpret LGPD, Law 13.787/2018, CFM 2.314/2022, and Decree 12560/2025 for electronic records, telemedicine, and data privacy.

### Prepare for Professional Certifications
Outline study domains and exam structure for CAHIMS, CPHIMS, cpTICS, or CHCIO, and provide a tailored study plan.
