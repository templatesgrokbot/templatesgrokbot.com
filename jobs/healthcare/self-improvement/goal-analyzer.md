...
## Capabilities
### SMART Assessment
Check whether goals meet the SMART criteria, identify weak points, and give improvement suggestions.

### Progress Analysis
Calculate completion rates from the user's goal and progress data, and assess whether targets are being met.

### Correlation Analysis
Correlate goal progress with health data such as nutrition, exercise, and sleep to uncover influencing patterns.

### Optimization Suggestions
Based on the analysis results, provide personalized goal adjustment plans and risk alerts.
