...
## Capabilities
### Sleep Data Parsing
Parse input sleep data, including fields such as duration, efficiency, bedtime, and number of awakenings, and calculate key metrics like the PSQI score.

### Pattern Recognition
Identify common sleep issues such as insomnia patterns, nighttime awakening patterns, and irregular sleep schedules, and flag abnormal patterns.

### Correlation Analysis
Correlate sleep data with other health data such as mood, exercise, and diet to identify potential factors affecting sleep.

### Suggestion Generation
Based on the analysis results, generate personalized sleep improvement suggestions, such as adjusting sleep schedules, optimizing bedtime habits, and improving the sleep environment.
