...
| [Actuarial Forecasting Assistant](../finance/data-analysis/actuarial-forecasting-assistant.md) | Turn insurance data into forecasts, risk models, and stakeholder-ready reports for actuarial decisions. |
| [Actuarial Predictive Analytics Assistant](../finance/data-analysis/actuarial-predictive-analytics-assistant.md) | Turns insurance data into predictive insights for actuarial decisions. |
| [Actuarial Reserving Assistant](../finance/data-analysis/actuarial-reserving-assistant.md) | Automates reserving data analysis, model building, validation, and documentation for insurance actuaries. |
...
| [Claim Event Analytics Assistant](../finance/data-analysis/claim-event-analytics-assistant.md) | Real-time claim event analytics and monitoring for insurance data analysts. |
...
| [Climate Risk Actuarial Analyst](../finance/data-analysis/climate-risk-actuarial-analyst.md) | Analyzes climate data and models to inform insurance risk, pricing, and strategy. |
...
| [Insurance Cost-Benefit Analyst](../finance/data-analysis/insurance-cost-benefit-analyst.md) | Cost-benefit analysis for insurance data analysts, from data prep to recommendations. |
...
| [Insurance Data Trend Forecaster](../finance/data-analysis/insurance-data-trend-forecaster.md) | Turns insurance market data into trend insights, forecasts, and strategic reports. |
| [Insurance Data Visualization Assistant](../finance/data-analysis/insurance-data-visualization-assistant.md) | Prepares insurance data and builds visual summaries and reports for analysts. |
...
| [Insurance Feedback Sentiment Analyzer](../finance/data-analysis/insurance-feedback-sentiment-analyzer.md) | Turns customer feedback into sentiment insights for insurance decisions. |
...
| [Insurance Pricing Strategy Analyst](../finance/data-analysis/insurance-pricing-strategy-analyst.md) | Insurance pricing strategy analyst: data analysis, modeling, and compliance for actuaries. |
...
| [Predictive Maintenance Analyst Assistant](../finance/data-analysis/predictive-maintenance-analyst-assistant.md) | Builds and runs predictive maintenance models for insurance policies, from data prep to forecasting and reporting. |
...
| [Client Risk Assessment Assistant](../management/security-and-compliance/client-risk-assessment-assistant.md) | Streamlines client risk assessment from data collection to monitoring and reporting. |
...
| Template | What it does |
|---|---|
| [Claims Processing Assistant](../customer-support/support-and-community/claims-processing-assistant.md) | Handles claim inquiries, document collection, status updates, and appeals for insurance customer service. |
| [Coverage Inquiry Assistant](../customer-support/support-and-community/coverage-inquiry-assistant.md) | Handles insurance coverage inquiries from verification to resolution for customer service reps. |
| [Customer Onboarding Assistant](../customer-support/support-and-community/customer-onboarding-assistant.md) | Guides new insurance customers through onboarding with personalized, step-by-step support. |
| [Damage Assessment Support](../operations/support-and-community/damage-assessment-support.md) | Assesses insurance damage from documents, photos, and data, and supports the full claims process. |
...
| [Initial Claims Intake Assistant](../operations/support-and-community/initial-claims-intake-assistant.md) | Guides claimants through initial insurance claims from intake to settlement. |
| [Insurance Claims Service Assistant](../operations/support-and-community/insurance-claims-service-assistant.md) | Handles insurance customer service tasks from inquiries to appeals, drafting responses and guides for approval. |
...
| [Insurance Payment Assistance Assistant](../customer-support/support-and-community/insurance-payment-assistance-assistant.md) | Handles insurance payment assistance: plans, extensions, reminders, processing, history, confirmations, and more. |
...
| [Policy Coverage Clarification Assistant](../operations/support-and-community/policy-coverage-clarification-assistant.md) | Clarifies insurance policy coverage, verifies details, and explains terms for claims processors. |
| [Policy Customization Assistant](../customer-support/support-and-community/policy-customization-assistant.md) | Guides insurance customers through customizing policies, from coverage options to claims assistance. |
...
| [Policy Renewal and Updates Assistant](../customer-support/support-and-community/policy-renewal-and-updates-assistant.md) | Handles policy renewals, updates, and customer inquiries for insurance service reps. |
...
| Template | What it does |
|---|---|
| [Claims Training Developer](../management/teaching-and-tutoring/claims-training-developer.md) | Builds and tracks staff training for insurance claims teams. |
| [Insurance Training Developer](../operations/teaching-and-tutoring/insurance-training-developer.md) | Build and manage the full training cycle for your insurance operations team. |
